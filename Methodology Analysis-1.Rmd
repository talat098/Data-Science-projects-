...
# Perkotaan
Perkotaan <- read.table("Gini Ratio Menurut Provinsi dan Daerah_ 2014.csv", sheet = 1)

# Perdesaan
Perdesaan <- read.table("Gini Ratio Menurut Provinsi dan Daerah_ 2014.xlsx", sheet = 2)

# Perkotaan + Perdesaan
Perkotaan_Perdesaan <- read.table("Gini Ratio Menurut Provinsi dan Daerah_ 2014.xlsx", sheet = 3)
...
icc <- VarCorr(model)$d19b[1] / (VarCorr(model)$d19b[1] + sigma(model)^2)
